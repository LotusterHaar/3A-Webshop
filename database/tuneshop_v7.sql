...
INSERT INTO `user` (`ID`, `UserName`, `FirstName`, `Prefix`, `Surname`, `Address`, `HouseNumber`, `ZipCode`, `City`, `PhoneNumber`, `EMail`, `Gender`, `Avatar`, `Password`, `Deleted`) VALUES
