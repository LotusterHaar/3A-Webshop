...
INSERT INTO `product` (`ID`, `SKU`, `ProductName`, `Description`, `FullDescription`, `Category`, `Price`, `Stock`, `ReminderList`, `Picture_Big`, `Picture_Small`, `Disabled`) VALUES
...
INSERT INTO `review` (`ReviewID`, `ProductID`, `UserID`, `Score`, `Review`, `Date`) VALUES
...
(3, 10, 3, 5, 'testsfsfdfssfsfd', '2019-08-19'),
(4, 8, 3, 3, 'redelijk product', '2019-08-19'),
(5, 6, 3, 4, 'ddsfffss', '2019-08-19'),
(6, 3, 3, 5, 'Super gaaf ding', '2019-08-22'),
(7, 5, 3, 2, 'beetje kromme fluit maar hij werkt wel', '2019-08-22'),
(8, 5, 1, 1, 'Super mooie fluit :) echt waard', '2019-08-22'),
(9, 1, 1, 2, 'javascript:alert(document.body.scrollHeight / window.innerHeight) ', '2019-08-22'),
(10, 3, 1, 2, 'ffdfdsfddfs\r\nTest paragraph. Other text\r\n\r\nsdfjfdkldjfslksfdjlkj23235325323523246;5686u4', '2019-08-22'),
(11, 10, 1, 1, 'test', '2019-08-22');
